    ...
    Column(verticalArrangement = Arrangement.spacedBy(24.dp)) {
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_GENERAL) {
            SettingItem(
                ...
                modifier = Modifier.focusRequester(modeR),
            ...
            SettingItem(
                ...
                modifier = Modifier.focusRequester(colorR),
                onClick = { onClick(colorR); onColor() })
            SettingItem(
                AppStrings.SETTINGS_ITEM_STARTUP_TAB,
                startupTab,
                Icons.Default.Home,
                modifier = Modifier.focusRequester(startR),
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_HOME_PICKUP) {
            SettingItem(
                ...
                modifier = Modifier.focusRequester(genreR),
                onClick = { onClick(genreR); onG() })
            SettingItem(
                AppStrings.SETTINGS_ITEM_PICKUP_TIME,
                pickupTime,
                Icons.Default.Schedule,
                modifier = Modifier.focusRequester(timeR),
            ...
            SettingItem(
                ...
                Icons.Default.Block,
                modifier = Modifier.focusRequester(exPaidR),
...
fun LabSettingsContent(
    ...
    shobocal: String,
    postCmd: String,
    annictR: FocusRequester,
    shobocalR: FocusRequester,
    cmdR: FocusRequester,
    onAnnict: () -> Unit,
    onShobocal: () -> Unit,
    onEditCmd: () -> Unit,
    ...
    Column(verticalArrangement = Arrangement.spacedBy(24.dp)) {
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_EXTERNAL_INTEGRATION) {
            SettingItem(
                ...
                Icons.Default.Sync,
                modifier = Modifier.focusRequester(annictR),
            ...
            SettingItem(
                ...
                modifier = Modifier.focusRequester(shobocalR),
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_RECORD_DETAIL) {
            SettingItem(
                ...
                modifier = Modifier.focusRequester(cmdR),
    ...
    Column(verticalArrangement = Arrangement.spacedBy(24.dp)) {
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_KONOMITV) {
            SettingItem(
                ...
                kIp,
                Icons.Default.Dns,
                modifier = Modifier.focusRequester(kIpR),
                onClick = { onClick(kIpR); onEdit(AppStrings.SETTINGS_INPUT_KONOMITV_ADDRESS, kIp) })
            SettingItem(
                AppStrings.SETTINGS_ITEM_PORT,
                kPort,
                modifier = Modifier.focusRequester(kPortR),
                onClick = { onClick(kPortR); onEdit(AppStrings.SETTINGS_INPUT_KONOMITV_PORT, kPort) })
        }
        SettingsSection(AppStrings.SETTINGS_SECTION_MIRAKURUN) {
            SettingItem(
                ...
                mIp,
                Icons.Default.Dns,
                modifier = Modifier.focusRequester(mIpR),
                onClick = { onClick(mIpR); onEdit(AppStrings.SETTINGS_INPUT_MIRAKURUN_ADDRESS, mIp) })
            SettingItem(
                AppStrings.SETTINGS_ITEM_PORT,
                mPort,
                modifier = Modifier.focusRequester(mPortR),
                onClick = { onClick(mPortR); onEdit(AppStrings.SETTINGS_INPUT_MIRAKURUN_PORT, mPort) })
        }
        SettingsSection(AppStrings.SETTINGS_SECTION_STREAM_SOURCE) {
            val isMirakurunAvailable = mIp.isNotBlank() && mPort.isNotBlank()
            val srcLabel =
                if (!isMirakurunAvailable) AppStrings.SETTINGS_VALUE_SOURCE_KONOMITV_FIXED else if (prefSrc == "MIRAKURUN") AppStrings.SETTINGS_VALUE_SOURCE_MIRAKURUN_PREFERRED else AppStrings.SETTINGS_VALUE_SOURCE_KONOMITV_PREFERRED
            SettingItem(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(24.dp)) {
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_SUBTITLE) {
            SettingItem(
                ...
                modifier = Modifier.focusRequester(liveSubR),
            ...
            SettingItem(
                ...
                modifier = Modifier.focusRequester(videoSubR),
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_LAYER) {
            ...
            SettingItem(
                ...
                modifier = Modifier.focusRequester(layerR),
    ...
    Column(verticalArrangement = Arrangement.spacedBy(24.dp)) {
        ...
        SettingsSection(AppStrings.SETTINGS_SECTION_COMMENT_DISPLAY) {
            SettingItem(
                ...
                Icons.Default.Chat,
                modifier = Modifier.focusRequester(defR),
                onClick = { onClick(defR); onT() })
            SettingItem(
                AppStrings.SETTINGS_ITEM_COMMENT_SPEED,
                speed,
                modifier = Modifier.focusRequester(spR),
                onClick = { onClick(spR); onEdit(AppStrings.SETTINGS_INPUT_COMMENT_SPEED, speed) })
            SettingItem(
                AppStrings.SETTINGS_ITEM_COMMENT_SIZE,
                size,
                modifier = Modifier.focusRequester(szR),
                onClick = { onClick(szR); onEdit(AppStrings.SETTINGS_INPUT_COMMENT_SIZE, size) })
            SettingItem(
                AppStrings.SETTINGS_ITEM_COMMENT_OPACITY,
                opacity,
                modifier = Modifier.focusRequester(opR),
                onClick = { onClick(opR); onEdit(AppStrings.SETTINGS_INPUT_COMMENT_OPACITY, opacity) })
            SettingItem(
                AppStrings.SETTINGS_ITEM_COMMENT_MAX_LINES,
                max,
                modifier = Modifier.focusRequester(mxR),
                onClick = { onClick(mxR); onEdit(AppStrings.SETTINGS_INPUT_COMMENT_MAX_LINES, max) })
        }
    }
}
